...
//
//
//        int memberId = getIntOrThrow("memberId");
//        int doctorPlanId = getIntOrThrow("doctorPlanId");
//        int beetLogPlanId = getIntOrThrow("beetLogPlanId");
//
//        // Logs
...
//        payload.put("orderSynReqList", Optional.ofNullable(DataStore.getList("orders")).orElse(new ArrayList<>()));
//        payload.put("sampleReqList", Optional.ofNullable(DataStore.getList("samples")).orElse(new ArrayList<>()));
//
...
//            }
//            payload.put(payloadKey, logReqList);
//        }
//    }
//
...
//    }
//
//    public static void debugDataStore() {
//        System.out.println("🔍 DataStore Dump:");
//        System.out.println("beetLogIds: " + DataStore.getList("beetLogIds"));
//        System.out.println("doctorLogIds: " + DataStore.getList("doctorLogIds"));
//        System.out.println("clientLogIds: " + DataStore.getList("clientLogIds"));
//        System.out.println("orders: " + DataStore.getList("orders"));
//        System.out.println("samples: " + DataStore.getList("samples"));
//        System.out.println("memberId: " + DataStore.getInt("memberId"));
//        System.out.println("doctorPlanId: " + DataStore.getInt("doctorPlanId"));
//        System.out.println("beetLogPlanId: " + DataStore.getInt("beetLogPlanId"));
//    }
//
...
//            System.out.println("beetLogPlanId: " + DataStore.getInt("beetLogPlanId"));
//        } catch (Exception e) {
//            System.err.println("❌ DataStore debug error: " + e.getMessage());
//        }
//    }
