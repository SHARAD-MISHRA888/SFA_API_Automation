...
public class StartJourneyTest {
    ...
    private static final String SALESPERSON_TOKEN = "eyJhbGciOiJIUzUxMiJ9.eyJtb2JpbGUiOjk5MTg0MDE0NTAsImlkIjo3NSwidXNlclJvbGUiOlsiTWFuYWdlciIsIkNyZWF0ZV9NYW5hZ2VyIiwiVmlld19NYW5hZ2VyIl0sInN1YiI6Ijk5MTg0MDE0NTAiLCJpYXQiOjE3NTMwODI5NTgsImV4cCI6MTc1NTI0Mjk1OH0.m8VGwXQY6Vg4IUO2L35UyAfkl2hijkIhuHjR7H4Uv5TQ5LxRbdHAdV16ouGv9FzH8tRVeUkD021WaYfLIG_hSg"; // truncated
    private static final int MEMBER_ID = 23;
    private static final int REPORTING_MANAGER_ID = 20;
    private static final String visitDate = "2025-08-01";
    ...
    @Test(priority = 6,dependsOnMethods = "startJourneyFlow")
    public void updateVehicleStatus(){
        String vehicleType = "CAR";
        StartJourneyUtil.updateVehicleType(SALESPERSON_TOKEN,MEMBER_ID,vehicleType,visitDate);
    }

   @Test(priority = 7,dependsOnMethods = "updateVehicleStatus")
   ...
   // @Test(priority = 7)
    public void updateWorkTypeAndVehicleType(){
    ...
    @Test(priority = 8,dependsOnMethods = "fetchCombinePlanAndExtractAllLogs")
  ...
  @Test(priority = 9,dependsOnMethods = "generateOrderAndSampleData")
   ...
   // @Test(priority = 10)
    public void punchOut(){
        String imageKey = StartJourneyUtil.uploadAttendanceImage(BASE64_IMAGE, SALESPERSON_TOKEN);
        Map<String, Object> attendancePayload = AttendancePayload.buildAttendanceBodyForCheckout(MEMBER_ID, REPORTING_MANAGER_ID, imageKey);
        StartJourneyUtil.markAttendance(attendancePayload, SALESPERSON_TOKEN);
